...
import placeholerImg from "../assets/placeholder.png";
...
export const editorials: Editorial[] = [
    ...
    },
    {
        ...
        tagline: "Is the onslaught of remade content keeping us from new experiences or" +
            " does making old games accessable give people a way to experience mechanically dated masterpieces?",
        img: placeholerImg,
        slug: "remakes-and-remasters-vs-new-content",
        body: ["here is some stuff.", "So many remakes and remasters with differing degress of quality.",
            "The money dumped into it keeps money from going into new content."],
    },
    {
        id: 3,
        title: "Is Early Access Going to Far?",
